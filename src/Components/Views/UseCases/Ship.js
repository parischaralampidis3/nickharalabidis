    ...
    <div className="container mx-auto mb-16">
      <div>
        <div className="flex flex-col mt-12 mb-16  items-center justify-center">
          <h1 className="text-center mb-6 text-4xl font-bold">Ship on the sea</h1>

          <div className="mb-4">

            <img
              className="w-3/4 bg-cyan-500 mt-8 mx-auto shadow-lg shadow-gray-300/50  lg:w-3/4"
              src="..\assets\images\project_images\painting_19.png"
              alt="project_image"
            />
       ...
       Ship on the open sea. cargo ship Liberty type in high seas in midships.
            </p>
          </div>
        </div>
      </div>
