      ...
      <div>
        <div className="flex flex-col mt-12 mb-16 items-center justify-center">
          ...
          <div className="mb-10">
            ...
            Egyptian slave shown by the hands of the slave trader.
            </p>
          </div>
        </div>
      </div>
