    ...
    <div className="container mb-16 mx-auto">
      <div>
        <div className="flex flex-col mt-12 mb-16 items-center justify-center">
          <h1 className="text-center mb-6 text-4xl font-bold">Flamingos</h1>

          <div className="mb-4">

            <img
              className="w-2/3 bg-cyan-500 mt-8 mx-auto shadow-lg shadow-gray-300/50  lg:w-2/4"
              src="..\assets\images\project_images\painting_9.png"
              alt="project_image"
            />
       ...
       Eight flamingos gathered on the background of their colors.
            </p>
          </div>
        </div>
      </div>
