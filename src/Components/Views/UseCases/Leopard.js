    ...
    <div className="container mx-auto mb-16">
      <div>
        <div className="flex flex-col mt-12 mb-16 items-center justify-center">
          <h1 className="text-center mb-6 w-2/3 text-4xl font-bold"> Siberian Amur Leopard</h1>

          <div className="mb-4">

            <img
              className="w-2/3 bg-cyan-500 mt-8 mx-auto shadow-lg shadow-gray-300/50  lg:w-2/4"
              src="..\assets\images\project_images\painting_8.png"
              alt="project_image"
            />
          ...
          <div className="mb-10">
            ...
            Beautiful siberian cat chased by siberian tiger. About 200 left.
            </p>
          </div>
        </div>
      </div>
